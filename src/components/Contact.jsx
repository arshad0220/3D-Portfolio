...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const emailJsParams = {
      serviceID: "service_0iahwth",
      templateID: "template_ux1q1or",
      userID: "an5S0q-JmrVzr3Y0k",
    };
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Arshad Ahamed",
          from_email: form.email,
          to_email: "ars007.smv@gmail.com", // Replace with your email address
